...
3.0为浏览器界面版，带了浏览器风格的界面，并带一些控制器，对应插件3.1.5在线版/3.2.5/离线版的所有功能
...
3.0 은 브라우저 인터페이스 버전으로 브라우저 스타일의 인터페이스와 일부 컨트롤러가 있으며 플러그인 3.1.5 온라인 버전/3.2.5/오프라인 버전의 모든 기능에 대응한다
